        ...
        <div className="auth-right-panel">
          ...
          <div className="auth-form-container">
            ...
            <div className="auth-oauth-row">
              <a href="/api/auth/google" className="auth-oauth-btn"><GoogleIcon /> Continue with Google</a>
              <a href="/api/github/auth" className="auth-oauth-btn auth-oauth-btn-github"><GitHubIcon /> Continue with GitHub</a>
            </div>
